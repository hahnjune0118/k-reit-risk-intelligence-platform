...
CSV_SCHEMAS: dict[str, list[str]] = {
    ...
    "asset_master.csv": [
        ...
        "direct_or_indirect", "investment_holding_type", "title_holding_type",
        "registered_owner", "trustee", "trustor", "beneficial_owner", "property_taxpayer",
        "listed_parent", "legal_owner_name", "legal_owner_type",
    ...
    "building_master.csv": [
        ...
        "building_standard_value", "building_standard_value_year", "building_standard_value_nature",
        "property_tax_base_method", "fire_resource_tax_base_method", "calculation_source",
        "fire_risk_category", "fire_tax_multiplier", "fire_tax_multiplier_status",
        "fire_tax_evidence_source_url", "fire_tax_evidence_page", "fire_tax_evidence_quote",
        "urban_area_status", "source_url", "source_page",
    ...
    "taxpayer_structure.csv": [
        ...
        "separation_tax_reason", "tax_classification", "statutory_eligibility_status",
        "actual_notice_classification", "legal_review_status", "notice_reconciliation_status",
        "assessment_date_ownership_basis_status", "assessment_date_ownership_verified",
    ...
    "tax_calculation_detail.csv": [
        ...
        "calculated_tax_before_end_digit_treatment", "end_digit_treatment_unit",
        "end_digit_treatment_method", "end_digit_treatment_legal_basis",
        "calculated_tax_after_end_digit_treatment", "end_digit_treatment_difference",
